	...
	var TeamList = React.createClass({
	  ...
	  render: function render() {
	    var bindTeams = this.state.teamList.map(function (team, i) {
	      return React.createElement('div', { key: i }, React.createElement('span', { className: 'tl-date', 'data-toggle': 'tooltip',
	        'data-placement': 'top', title: 'Tooltip on top' }, team.teamCode, ' / ', team.teamName));
	    });
