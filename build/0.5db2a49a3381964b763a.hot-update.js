...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuildLiComponents = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement('li', { className: 'tl-item', id: this.props.team.teamCode, 'data-id': this.props.teamLabelId }, React.createElement('div', { className: 'tl-wrap' }, React.createElement('a', { href: this.props.teamId }, React.createElement('span', { className: 'tl-date', 'data-toggle': 'tooltip',
