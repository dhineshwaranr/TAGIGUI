...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuildLiComponents = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement('li', { className: 'tl-item', id: this.props.team.teamCode, 'data-id': 'teamid{this.props.team.teamId}' }, React.createElement('div', { className: 'tl-wrap' }, React.createElement('span', { className: 'tl-date', 'data-toggle': 'tooltip',
