...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuildLiChildComponents = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement('a', { href: this._buildLinkHref(this.props.data.projectId), className: true }, React.createElement('div', { className: this.props.className }, React.createElement('p', null, this.props.data.projectCode, React.createElement('span', { className: 'projectNameSpan' }, this.props.data.projectName))));
	    }
	});
