...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createElement(Router, { history: history }, React.createElement(Route, { component: App }, React.createElement(Redirect, { from: '/', to: '/dashboard/list' }), React.createElement(Route, { path: 'dashboard', component: Dashboard }, React.createElement(Route, { path: 'list', component: DashboardMainSection }), React.createElement(Route, { path: 'team/:teamId', component: TeamComponent }), React.createElement(Route, { path: 'team/', component: TeamComponent }), React.createElement(Route, { path: 'project/:teamId/:projectId', component: ProjectComponent })), React.createElement(Route, { path: '*', component: NotFound })));
