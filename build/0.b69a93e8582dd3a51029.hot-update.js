...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuildLiChildComponents = React.createClass({
	    ...
	    getTeamId: function getTeamId(e) {
	        var teamId = $("#" + e.currentTarget.id).parent('li').attr('data-id');
	        console.log(teamId);
	    },

	    render: function render() {
	        return React.createElement('a', { href: this._buildLinkHref(this.props.data.projectId), id: this._builddataid(this.props.data.projectId), onClick: this.getTeamId, className: true }, React.createElement('div', { className: this.props.className }, React.createElement('p', null, this.props.data.projectCode, React.createElement('span', { className: 'projectNameSpan' }, this.props.data.projectName))));
	    }
	});
