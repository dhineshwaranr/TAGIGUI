...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createElement(Router, { history: history }, React.createElement(Route, { component: App }, React.createElement(Redirect, { from: '/', to: '/dashboard/teams' }), React.createElement(Route, { path: 'dashboard', component: Dashboard }, React.createElement(Route, { path: 'teams', component: ListTeams }), React.createElement(Route, { path: 'projects', component: ListProjects })), React.createElement(Route, { path: '*', component: NotFound })));
