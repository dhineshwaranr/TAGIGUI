...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuildLiComponents = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('li', { className: 'tl-item', id: this.props.data.teamCode }, React.createElement('div', { className: 'tl-wrap' }, React.createElement('span', { className: 'tl-date', 'data-toggle': 'tooltip',
