...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuildLiComponents = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('li', { className: 'tl-item', id: this.props.team.teamCode }, React.createElement('div', { className: 'tl-wrap', 'data-name': this.props.data.length }, React.createElement('span', { className: 'tl-date', 'data-toggle': 'tooltip',
