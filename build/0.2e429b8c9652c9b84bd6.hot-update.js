	    ...
	    var bindComponents = this.props.projects.map(function (project, i) {
	      if (project.length > 0) {
	        return React.createElement(BuildLiChildComponents, { key: i, data: project,
	          className: 'rs-tl-box waves-effect waves-light disabled', teamId: teamId });
	      } else {
	        return React.createElement(BuildLiChildComponents, { key: i, data: project,
	          className: 'rs-tl-box waves-effect waves-light' });
	      }
	    });
	    return React.createElement('li', { className: 'tl-item', id: this.props.team.teamCode, 'data-id': this.props.teamLabelId }, React.createElement('div', { className: 'tl-wrap' }, React.createElement('span', { className: 'tl-date', 'data-toggle': 'tooltip',
