...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuildLiChildComponents = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement('a', { href: this._buildLinkHref(this.props.data.pk),
	            'data-roadshow-id': this.props.data.pk,
	            className: true }, React.createElement('div', { className: this.props.className }, this.props.data.fields.title));
	    }
	});
