...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuildLiComponents = __webpack_require__(273);
	var NotFound = __webpack_require__(132);

	module.exports = React.createElement(Router, { history: history }, React.createElement(Route, { component: App }, React.createElement(Redirect, { from: '/', to: '/dashboard/teams' }), React.createElement(Route, { path: 'dashboard', component: Dashboard }, React.createElement(Route, { path: 'list', component: BuildLiComponents })), React.createElement(Route, { path: '*', component: NotFound })));
